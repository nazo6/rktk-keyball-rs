...
pub fn get_opts_right() -> RktkOpts<DefaultDisplayConfig, layout::LayoutRight> {
    RktkOpts {
...
pub fn get_opts_left() -> RktkOpts<DefaultDisplayConfig, layout::LayoutLeft> {
    RktkOpts {
        keymap: &crate::keymap::KEYMAP,
        hand: Some(Hand::Left),
        config: &rktk::config::DYNAMIC_CONFIG_FROM_FILE,
